...
export const CIRCUIT_TEMPLATES: Circuit[] = [
  ...
  },
  {
    ...
    stations: [
      ...
      { name: "Flexiones", equipment: "peso corporal", workSec: 40, note: "Si fallas, apoya las rodillas y sigue sin parar." },
      { name: "Escalador", equipment: "peso corporal", workSec: 40, note: "Cadera baja, rodilla al pecho." },
      { name: "Plancha con toque de hombro", equipment: "esterilla", workSec: 40, note: "Sin balancear la cadera: pies algo separados." },
      { name: "Salto de comba o rodillas altas", equipment: "comba", workSec: 40, note: "Sin comba, rodillas altas al mismo ritmo." },
    ],
  },
  {
  ...
  },
  {
    ...
    roundRestSec: 75,
    stations: [
      { name: "Paso de monstruo", equipment: "banda corta", workSec: 40, note: "Banda en los tobillos, media sentadilla, pasos en diagonal hacia delante." },
      ...
      { name: "Patada de glúteo a cuatro apoyos", equipment: "banda corta", workSec: 40, reps: "15 por lado", note: "Banda entre el pie y las manos. Empuja el talón al techo." },
      ...
      { name: "Abducción tumbado", equipment: "banda corta", workSec: 40, reps: "20 por lado", note: "Pierna estirada, sube despacio y baja más despacio aún." },
      { name: "Puente a una pierna", equipment: "banda corta", workSec: 40, reps: "12 por lado", note: "Banda sobre las rodillas. Cadera a la misma altura los dos lados." },
    ],
  },
  {
    ...
    roundRestSec: 90,
    stations: [
      { name: "Remo a una mano", equipment: "banda larga", workSec: 45, reps: "12 por lado", note: "Anclada a media altura. Gira un poco el tronco al tirar." },
      { name: "Press de pecho", equipment: "banda larga", workSec: 45, note: "Banda por detrás de la espalda. Un paso adelante para tensarla más." },
      { name: "Face pull", equipment: "banda larga", workSec: 45, note: "Anclada alto. Lleva las manos a las orejas abriendo los codos." },
      { name: "Curl de bíceps", equipment: "banda larga", workSec: 45, note: "Pisa la banda. Codos quietos pegados al cuerpo." },
      { name: "Extensión de tríceps sobre la cabeza", equipment: "banda larga", workSec: 45, note: "Anclada baja, de espaldas al anclaje." },
      { name: "Pull-apart", equipment: "banda larga", workSec: 45, note: "Brazos estirados al frente, abre hasta tocar el pecho con la banda." },
    ],
  },
  {
    ...
    roundRestSec: 60,
    stations: [
      { name: "Sentadilla con salto", equipment: "peso corporal", workSec: 20, note: "Aterriza suave, rodillas mirando a los pies." },
      { name: "Flexiones explosivas", equipment: "peso corporal", workSec: 20, note: "Si no despegan las manos, hazlas normales y rápidas." },
      { name: "Remo con banda larga", equipment: "banda larga", workSec: 20, note: "Anclada a media altura, tirones cortos y seguidos." },
